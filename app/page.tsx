    ...
    <div>
      ...
      <main className="relative z-10">
        <div className="max-w-6xl mx-auto px-6 py-24 space-y-32">
          ...
          <section>
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
              {[
                ...
                <div
                  key={item.step}
                  className="flex items-start gap-6 p-6 bg-white/20 rounded-xl border-2 border-white/20 hover:border-white/30 transition-all duration-500"
                >
          ...
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={item.title}
                  className="p-6 bg-white/20 rounded-xl border-2 border-white/20 hover:border-white/30 transition-all duration-500"
                >
          ...
          <section className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent rounded-2xl p-8 md:p-12 border-2 border-primary/30">
          ...
          {/* Assistant IA métier */}
          {/* Increased opacity from bg-white/5 to bg-white/20 and border width */}
          <section className="bg-white/20 rounded-2xl p-8 md:p-12 border-2 border-white/20">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={item.title}
                  className="p-6 bg-white/20 rounded-xl border-2 border-white/20 hover:border-primary/20 transition-all duration-500"
                >
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3 mb-8">
                  {[
                    ...
                    <Link
                      ...
                      className="px-4 py-2 bg-white/20 border-2 border-white/20 rounded-lg text-center hover:border-primary/50 transition-all duration-500 font-sans leading-6 font-bold text-xl"
