...
export const metadata = createPageMetadata({
  title: "Intégrateur IA Angoulême | Automatisation PME Charente | Assistant IA & Reporting",
  path: "/ville/angouleme",
  description:
    "Intégrateur IA pour TPE/PME à Angoulême. Automatisation des processus, assistant IA métier, reporting temps réel, audit 360°. Visite 60–90 min. Plan d'action et devis sous 48 h.",
})
...
export default function AngoulemePage() {
  return (
    <div className="min-h-screen text-white">
      ...
      {/* Hero */}
      <section className="pt-12 md:pt-16 pb-12 px-4 sm:px-6 md:pb-0">
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 bg-white/5">
        <div className="max-w-5xl mx-auto">
          <p className="text-base md:text-lg lg:text-xl text-white/80 leading-relaxed">
            Vous cherchez un intégrateur IA à Angoulême pour automatiser vos processus, déployer un assistant IA métier
            et livrer un reporting temps réel connecté à vos outils. Priorité TPE/PME charentaises. Approche terrain,
            sur-mesure, orientée croissance/ROI.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                examples: "Exemples: devis→commande→facture, OCR factures fournisseurs avec contrôles, relances DSO.",
              ...
              },
              {
                ...
                examples:
                  "Exemples: réponse client assistée, tri/solution de tickets, synthèse contrats et procédures.",
              ...
              <div
                key={i}
                className="p-6 md:p-8 border-2 border-white/30 rounded-xl bg-white/30 hover:bg-white/40 hover:border-white/40 transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div
                key={i}
                className="p-6 md:p-7 border-2 border-white/30 rounded-xl bg-white/30 hover:bg-white/40 hover:border-white/40 transition-all duration-300"
              >
                <h3 className="text-lg md:text-xl font-semibold mb-2 leading-tight">{useCase.title}</h3>
                {useCase.location && <p className="text-white/50 text-xs md:text-sm mb-3 italic">{useCase.location}</p>}
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/30 border-2 border-white/30 rounded-xl p-6 md:p-8 lg:p-10">
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-10 md:mb-12 text-center">FAQ — Angoulême</h2>
          <Accordion type="single" collapsible className="space-y-4 md:space-y-5">
            <AccordionItem
              value="item-1"
              className="border-2 border-white/30 rounded-xl px-5 md:px-6 bg-white/30 hover:bg-white/40 transition-colors"
            >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              <Link
                key={i}
                href={link.href}
                className="p-4 md:p-5 border-2 border-white/30 rounded-lg bg-white/30 hover:bg-white/40 hover:border-white/40 transition-all duration-300 text-center text-sm md:text-base font-medium"
              >
                {link.label}
              </Link>
            ))}
