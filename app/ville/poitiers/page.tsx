...
export default function PoitiersPage() {
  return (
    <div className="min-h-screen text-white">
      ...
      {/* Hero */}
      <section className="pt-52 md:pt-56 lg:pt-60 pb-12 px-4 sm:px-6 md:pb-3.5">
      ...
      {/* Pourquoi cette page */}
      <section className="py-12 px-4 sm:px-6 bg-white/5 md:py-0">
        <div className="max-w-5xl mx-auto">
          <p className="text-base md:text-lg lg:text-xl text-white/80 leading-relaxed">
            Vous cherchez un intégrateur IA à Poitiers pour automatiser vos processus, déployer un assistant IA métier
            et livrer un reporting temps réel connecté à vos outils. Intervention prioritaire pour TPE/PME poitevines
            avec une approche terrain, sur mesure, orientée croissance/ROI.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 md:mb-12 text-center">
            Cas d'usage locaux (Poitiers, Buxerolles, Chasseneuil-du-Poitou, Saint-Benoît)
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              {
                title: "Industrie / sous-traitance",
                desc: "TRS/OTD en direct, contrôles qualité, alertes retards et ruptures.",
              },
              {
                title: "Négoce / distribution",
                desc: "Automatiser devis→BL→facture, synchroniser stocks multi-canaux, réassorts dynamiques.",
              },
              {
                title: "Tech / Futuroscope / tourisme",
                desc: "Assistants FAQ internes, planification d'interventions, tableaux ROAS.",
              },
              {
              ...
              {
                title: "Logistique",
                desc: "WMS↔ERP, préparation de tournées, suivi des délais et incidents.",
              },
            ].map((useCase, i) => (
              <div
                key={i}
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-10 md:mb-12 text-center">FAQ — Poitiers</h2>
