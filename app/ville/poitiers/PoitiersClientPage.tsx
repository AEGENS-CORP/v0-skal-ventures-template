...
export default function PoitiersClientPage() {
  ...
  const services = [
    {
      ...
      subtitle: "Workflows intelligents et fiables",
      icon: "Zap",
    ...
    },
    {
      ...
      subtitle: "IA conversationnelle sur vos documents",
      icon: "Brain",
    ...
    },
    {
      ...
      subtitle: "Reporting temps réel connecté",
      icon: "TrendingUp",
    ...
    },
    {
      ...
      subtitle: "Vision 360° de vos processus",
      icon: "ShieldCheck",
      link: "/services/audit",
      animationIndex: 3,
    },
  ...
  return (
    <div className="relative min-h-screen text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            areaServed: ["Poitiers", "Vienne", "Nouvelle-Aquitaine"],
            sameAs: [],
          }),
        }}
      />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              {
                "@type": "Question",
                name: "Le reporting est-il en temps réel à Poitiers ?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              {
                "@type": "Question",
                name: "Comment démarrer à Poitiers ?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Planifiez la visite. Vous recevez un plan et un devis sous 48 h.",
                },
              },
            ],
          }),
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accueil", item: "https://aegens.com/" },
              {
                ...
                position: 2,
                name: "Poitiers",
                item: "https://aegens.com/ville/poitiers",
              },
            ],
          }),
        }}
      ...
      <section className="relative pt-52 md:pt-56 lg:pt-60 pb-12 px-4 sm:px-6 md:pb-16 z-10">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 md:mb-8 bg-gradient-to-br from-white via-gray-200 to-gray-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]">
            Intégrateur IA à Poitiers (Vienne)
          </h1>
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/70 mb-10 md:mb-12 leading-relaxed max-w-3xl mx-auto">
            Orienté solution sur mesure et croissance ROI
          </p>
        </div>
      </section>

      <section className="relative py-12 px-4 sm:px-6 bg-white/5 z-10">
        <div className="max-w-5xl mx-auto">
          <p className="text-base md:text-lg lg:text-xl text-white/80 leading-relaxed text-center">
            Vous cherchez un intégrateur IA à Poitiers pour automatiser vos processus, mettre en place un assistant IA
            métier et obtenir une visibilité temps réel sur votre activité. Priorité TPE/PME de Poitiers et Vienne.
            Approche terrain, sur-mesure, orientée résultat.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-8 scroll-reveal-premium">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-br from-white via-gray-200 to-gray-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]">
              Services IA pour TPE/PME à Poitiers
            </h2>
                            ...
                            <div className="relative flex items-center gap-3 mb-4 pb-3 border-b border-white/40">
                              ...
                              <div className="flex-1 text-left overflow-hidden">
                                ...
                                <div className="text-sm sm:text-base text-white font-semibold leading-tight animate-typing-cycle-premium drop-shadow-[0_2px_6px_rgba(0,0,0,0.4)]">
                                  Qu'est-ce qui manque aujourd'hui pour que tout...
                                </div>
                              </div>
      ...
      {/* Cas d'usage locaux (Poitiers, Chasseneuil-du-Poitou, Migné-Auxances, Saint-Benoît) */}
      <section className="relative py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5 z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              {
                title: "Industrie, équipements, sous-traitance",
                desc: "Planning, ordres de fabrication, suivi d'avancement, contrôles, traçabilité, consolidation des chiffres de prod.",
              },
              {
                title: "Services B2B, cabinets, structures para-publiques",
                desc: "Préparation et gestion de dossiers, automatisation des échanges standard, extraction et structuration d'informations.",
              },
              {
                title: "Formation, éducation, structures d'accueil",
                desc: "Gestion de dossiers, inscriptions, relances, échanges mails, reporting d'activité.",
              },
              {
                title: "Retail, e-commerce local, franchises",
                desc: "Suivi CA, marges, stocks, commandes, livraisons, retours.",
              },
              {
                title: "Tourisme, culture, loisirs",
                desc: "Demandes d'info, réservations, retours clients, pilotage d'événements, reporting finance/partenaires.",
              },
            ].map((useCase, i) => (
              <div
                key={i}
                className={`p-6 md:p-7 border-4 border-white/20 border-t-white/60 border-l-white/50 hover:border-white/40 hover:border-t-white/80 hover:border-l-white/70 rounded-xl bg-black/33 hover:bg-white/5 transition-all duration-500 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] ${i % 2 === 0 ? "scroll-reveal-left" : "scroll-reveal-right"}`}
          ...
          <p className="text-white/60 text-center mt-10 md:mt-12 italic text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            Tout est adaptable. Pas de solution générique plaquée : on colle à vos processus existants et on les
            fiabilise.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
            {[
              {
                num: "1",
                title: "Visite sur site à Poitiers",
                desc: "60–90 min, immersion dans vos flux, vos outils et vos contraintes.",
              },
              {
                num: "2",
                title: "Cadrage sous 48 h",
                desc: "Objectifs, KPI, périmètre prioritaire, risques, responsabilités.",
              },
              {
                num: "3",
                title: "Pilote 30 jours",
                desc: "Un processus métier automatisé ou un assistant IA métier déployé sur un périmètre clair.",
              },
              {
                num: "4",
                title: "Mise en production",
                desc: "Sécurité, gouvernance des données, formation équipes, bascule progressive.",
              },
              {
                num: "5",
                title: "Ops managées",
                desc: "Monitoring, petites évolutions, revues régulières des KPI.",
              },
            ].map((step, i) => (
              <div key={i} className={`relative group scroll-reveal-left`} style={{ transitionDelay: `${i * 120}ms` }}>
      ...
      <section className="relative py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5 z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-black/33 border-4 border-white/20 border-t-white/60 border-l-white/50 rounded-xl p-6 md:p-8 lg:p-10 scroll-reveal-scale">
            <ul className="space-y-4 md:space-y-5 text-white/70 text-base md:text-lg">
              <li className="flex items-start gap-3 md:gap-4 leading-relaxed">
                <Target className="w-5 h-5 md:w-6 md:h-6 text-white/50 flex-shrink-0 mt-1" />
                <span>Objectifs chiffrés validés dès le départ.</span>
              </li>
              <li className="flex items-start gap-3 md:gap-4 leading-relaxed">
                <ShieldCheck className="w-5 h-5 md:w-6 md:h-6 text-white/50 flex-shrink-0 mt-1" />
                <span>Mesures fondées sur vos outils (ERP, CRM, WMS, comptabilité).</span>
              </li>
              <li className="flex items-start gap-3 md:gap-4 leading-relaxed">
                <TrendingUp className="w-5 h-5 md:w-6 md:h-6 text-white/50 flex-shrink-0 mt-1" />
                <span>Focus : temps gagné, erreurs évitées, capacité absorbée, fiabilité des données.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <Link href="/contact" className="block no-underline">
          <div className="bg-black/33 backdrop-blur-xl rounded-3xl p-6 sm:p-10 md:p-16 lg:p-20 text-center border-4 border-white/20 border-t-white/60 border-l-white/50 hover:border-white/40 hover:border-t-white/80 hover:border-l-white/70 transition-all duration-500 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.3),0_0_30px_rgba(255,255,255,0.1)] max-w-5xl mx-auto cursor-pointer group scroll-reveal-scale">
            ...
            <div className="flex justify-center">
              <div className="px-8 py-4 bg-white text-black rounded-xl font-bold text-lg hover:bg-white/90 transition-all duration-300 group-hover:scale-105 flex items-center gap-2">
