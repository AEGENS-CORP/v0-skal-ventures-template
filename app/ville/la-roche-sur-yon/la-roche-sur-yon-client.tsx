...
import { Zap, CheckCircle, ArrowRight, Brain, TrendingUp, ShieldCheck, Check, Clock, Search, Eye } from "lucide-react"
import { useEffect, useState } from "react"

export default function LaRocheSurYonClientPage() {
  ...
  return (
    <div className="relative min-h-screen text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            areaServed: ["La Roche-sur-Yon", "Vendée", "Pays de la Loire"],
            sameAs: [],
          }),
        }}
      />
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accueil", item: "https://aegens.com/" },
              {
                ...
                item: "https://aegens.com/ville/la-roche-sur-yon",
              },
            ],
          }),
        }}
      ...
      <section className="relative z-10 pt-52 md:pt-56 lg:pt-60 pb-12 px-4 sm:px-6 md:pb-16">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 md:mb-8 text-balance leading-[1.1] bg-gradient-to-br from-white via-gray-200 to-gray-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]">
            Intégrateur IA à La Roche-sur-Yon (Vendée)
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white/80 mb-8 md:mb-10 leading-relaxed max-w-4xl mx-auto">
      ...
      <section className="relative z-10 py-12 px-4 sm:px-6 md:py-16 scroll-reveal-premium">
        <div className="max-w-5xl mx-auto bg-black/33 rounded-2xl p-6 md:p-8 border-4 border-white/20 border-t-white/60 border-l-white/50">
          <p className="text-base md:text-lg lg:text-xl text-white/80 leading-relaxed">
            Vous cherchez un intégrateur IA à La Roche-sur-Yon pour automatiser vos processus, déployer un assistant IA
            métier et obtenir un reporting temps réel connecté à vos outils. Priorité TPE/PME de l'agglo yonnaise (La
            Roche-sur-Yon, Mouilleron-le-Captif, Venansault, Dompierre-sur-Yon, Aubigny-Les Clouzeaux…). Approche
            terrain, sur-mesure, orientée croissance et ROI.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-8 scroll-reveal-premium">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-br from-white via-gray-200 to-gray-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]">
              Services IA pour TPE/PME à La Roche-sur-Yon
            </h2>
          ...
          <div className="max-w-6xl mx-auto space-y-8 mb-10 sm:mb-12">
            {/* Service 1: Automatisation - with full workflow animation */}
            <Link href="/services/automatisation" className="block group no-underline">
              <div className="relative p-4 bg-black/33 rounded-2xl border-4 border-white/20 border-t-white/60 border-l-white/50 hover:border-white/40 hover:border-t-white/80 hover:border-l-white/70 transition-all duration-500 hover:translate-x-2 hover:shadow-[0_0_40px_rgba(255,255,255,0.15)] cursor-pointer min-h-[300px] flex flex-col scroll-reveal-left">
                ...
                {/* Full workflow animation from homepage */}
              ...
              <div className="relative p-4 bg-black/33 rounded-2xl border-4 border-white/20 border-t-white/60 border-l-white/50 hover:border-white/40 hover:border-t-white/80 hover:border-l-white/70 transition-all duration-500 hover:translate-x-2 hover:shadow-[0_0_40px_rgba(255,255,255,0.15)] cursor-pointer min-h-[300px] flex flex-col scroll-reveal-right">
                <div className="flex items-start gap-4 relative z-10 mb-4">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-white/70 font-medium group-hover:text-white/90 transition-colors duration-300">
                      Cartographie des risques et des gains
                    </p>
                  </div>
                  <div className="flex-shrink-0 text-white opacity-0 group-hover:opacity-100 group-hover:translate-x-2 transition-all duration-300">
                    <ArrowRight className="w-5 h-5" />
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 md:mb-12 text-center bg-gradient-to-br from-white via-gray-200 to-gray-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]">
            Cas d'usage locaux (La Roche-sur-Yon Agglomération)
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              {
                title: "Industrie / production / robotique",
                desc: "Planification et ordonnancement, contrôles qualité, suivi TRS/OTD, gestion des rebuts et non-conformités, intégration avec ERP et outils de production.",
              },
              {
                title: "Logistique / transport / services de proximité",
                desc: "Préparation de tournées, WMS ↔ ERP, suivi des délais, alertes incidents, preuves de livraison.",
              },
              {
                title: "Services B2B / cabinets / prestataires",
                desc: "Assistant documentaire sourcé, préparation de dossiers, saisies automatisées, SLA support, suivi des engagements.",
              },
              {
                title: "Retail / e-commerce / commerce de détail",
                desc: "Cohérence catalogue, automatisation commandes → expéditions → factures, relances, dashboards ROAS et marges.",
              },
              {
                title: "Immobilier, nettoyage, services aux entreprises",
                desc: "Suivi des contrats, planning d'interventions, comptes-rendus automatiques, facturation récurrente, reporting par site ou par client.",
              },
              {
                title: "Tout secteur tertiaire local",
                desc: "Content ops assistés (brief → V1 → validation), gestion des demandes entrantes, reporting clients/partenaires.",
              },
            ].map((useCase, i) => (
              <div
                key={i}
                className={`p-6 md:p-7 border-4 border-white/20 border-t-white/60 border-l-white/50 rounded-xl bg-black/33 hover:border-white/40 hover:border-t-white/80 hover:border-l-white/70 transition-all duration-300 hover:scale-105 ${i % 2 === 0 ? "scroll-reveal-left" : "scroll-reveal-right"}`}
          ...
          <p className="text-white/60 text-center mt-10 md:mt-12 italic text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            Pas de refonte lourde par défaut : on part de vos outils, vos contraintes et vos idées, et on construit
            autour.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
            {[
              {
                num: "1",
                title: "Visite sur site à La Roche-sur-Yon",
                desc: "60–90 minutes sur le terrain : observation des flux, exceptions, irritants du quotidien.",
              },
              {
                num: "2",
                title: "Cadrage sous 48 h",
                desc: "Objectifs, KPI, périmètre, jalons, responsabilités, risques.",
              },
              {
                num: "3",
                title: "Pilote 30 jours",
                desc: "Un flux automatisé, un assistant métier ou un tableau de bord temps réel, testé sur des cas réels.",
              },
              {
                num: "4",
                title: "Mise en production",
                desc: "Sécurité, droits d'accès, formation, bascule progressive, runbook.",
              },
              {
                num: "5",
                title: "Ops managées",
                desc: "Supervision, petites évolutions, revues régulières avec vos équipes.",
              },
            ].map((step, i) => (
              <div key={i} className="relative group scroll-reveal-scale" style={{ transitionDelay: `${i * 100}ms` }}>
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-black/20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 md:mb-8 text-center bg-gradient-to-br from-white via-gray-200 to-gray-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]">
          ...
          <div className="bg-black/33 border-4 border-white/20 border-t-white/60 border-l-white/50 rounded-xl p-6 md:p-8 lg:p-10">
            <ul className="space-y-4 md:space-y-5 text-white/70 text-base md:text-lg">
              <li className="flex items-start gap-3 md:gap-4 leading-relaxed">
                ...
                <span>Objectifs chiffrés validés dès le cadrage.</span>
              </li>
              <li className="flex items-start gap-3 md:gap-4 leading-relaxed">
                <CheckCircle className="w-5 h-5 md:w-6 md:h-6 text-white/50 flex-shrink-0 mt-1" />
                <span>Mesure avant / après sur vos outils (ERP, CRM, WMS/MES, compta…).</span>
              </li>
              <li className="flex items-start gap-3 md:gap-4 leading-relaxed">
                <CheckCircle className="w-5 h-5 md:w-6 md:h-6 text-white/50 flex-shrink-0 mt-1" />
                <span>
      ...
      <section className="py-16 md:py-20 lg:py-24 px-4 sm:px-6">
        <Link href="/contact" className="block group no-underline">
          <div className="max-w-4xl mx-auto text-center bg-black/33 backdrop-blur-xl rounded-3xl p-6 sm:p-10 md:p-16 lg:p-20 border-4 border-white/20 border-t-white/60 border-l-white/50 hover:border-white/40 hover:border-t-white/80 hover:border-l-white/70 transition-all duration-500 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.3),0_0_30px_rgba(255,255,255,0.1)] cursor-pointer">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 md:mb-8 text-balance leading-tight bg-gradient-to-br from-white via-gray-200 to-gray-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]">
              Planifier une visite sur site
            </h2>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/80 mb-6 md:mb-8 leading-relaxed max-w-2xl mx-auto">
              Visite 60–90 minutes dans votre entreprise à La Roche-sur-Yon ou dans l'agglo.
              <br />
            ...
            <Button
              size="lg"
              className="mt-8 px-8 sm:px-10 md:px-12 py-5 sm:py-6 md:py-7 text-base sm:text-lg md:text-xl bg-white text-black hover:bg-white/90 group-hover:scale-105 transition-all duration-300"
            >
              Prendre contact
            </Button>
          </div>
