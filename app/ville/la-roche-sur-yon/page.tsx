...
export default function LaRocheSurYonPage() {
  return (
    <div className="min-h-screen text-white">
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Non par défaut. Nous connectons vos outils existants (ERP, CRM, comptabilité, e-commerce, WMS/MES, GED). Une alternative n'est proposée que si le ROI est évident.",
                },
              },
              {
                "@type": "Question",
                name: "Reporting temps réel ou J+1 à La Roche-sur-Yon ?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Temps réel quand la source le permet ; sinon latence minute/heure définie au cadrage. Les sources de vérité sont tracées et testées.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Un pilote cible peut livrer des résultats en environ 30 jours selon périmètre et accès.",
                },
              },
              {
                "@type": "Question",
                name: "Comment sont gérées les données sensibles ?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Accès par rôles, cloisonnement des environnements, journaux d'audit. Hébergement UE possible. DPA/RGPD sur demande.",
                },
              },
            ],
          }),
      ...
      {/* Pourquoi cette page */}
      <section className="py-12 px-4 sm:px-6 bg-white/5 md:py-16">
        <div className="max-w-5xl mx-auto">
          <p className="text-base md:text-lg lg:text-xl text-white/80 leading-relaxed">
            Vous cherchez un intégrateur IA à La Roche-sur-Yon capable d'automatiser vos flux, de déployer un assistant
            IA métier sur vos documents et de livrer un reporting temps réel connecté à vos outils existants. Nous
            opérons pour TPE/PME vendéennes avec une approche terrain, sur mesure, orientée croissance/ROI.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                examples:
                  "Exemples: devis→commande→facture, OCR factures fournisseurs avec contrôle, relances clients pilotées.",
              ...
              },
              {
                ...
                desc: "RAG sécurisé, réponses sourcées, gabarits prêts à valider.",
              ...
              {
                title: "Vente / Gestion",
                desc: "Parcours de A à Z jusqu'au support/SLA.",
                examples: "",
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 md:mb-12 text-center">
            Cas d'usage locaux (La Roche-sur-Yon et Vendée)
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              {
                title: "Négoce / distribution",
                desc: "Automatiser devis→BL→facture, synchroniser stocks multi-canaux, relances DSO.",
              },
              {
                title: "Industrie / ateliers",
                desc: "TRS/OTD, retards en direct, contrôles qualité avec exceptions documentées.",
              },
              {
                title: "Agroalimentaire / logistique",
                desc: "Traçabilité lots, seuils dynamiques de réassort, alertes ruptures.",
              },
              {
                title: "Cabinets comptables",
                desc: "Assistant documentaire sourcé, capture pièces, réponses guidées.",
              },
              {
              ...
              {
                title: "Services B2B",
                desc: "Base de connaissances interne, support piloté SLA, comptes-rendus automatiques.",
              },
            ].map((useCase, i) => (
              <div
                key={i}
          ...
          <p className="text-white/60 text-center mt-10 md:mt-12 italic text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            Tout est étudiable. On part de vos idées et de votre contexte. Pas de refonte lourde par défaut.
          </p>
        </div>
      </section>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 md:p-8 lg:p-10">
            <ul className="space-y-4 md:space-y-5 text-white/70 text-base md:text-lg">
              <li className="flex items-start gap-3 md:gap-4 leading-relaxed">
                ...
                <span>Objectifs chiffrés fixés au cadrage.</span>
              </li>
              <li className="flex items-start gap-3 md:gap-4 leading-relaxed">
                <CheckCircle className="w-5 h-5 md:w-6 md:h-6 text-white/50 flex-shrink-0 mt-1" />
                <span>Mesure avant/après avec source de vérité (ERP, CRM, WMS/MES, compta).</span>
              </li>
              <li className="flex items-start gap-3 md:gap-4 leading-relaxed">
                <CheckCircle className="w-5 h-5 md:w-6 md:h-6 text-white/50 flex-shrink-0 mt-1" />
                <span>
                  Focus: temps de saisie, taux d'erreurs, délai de réponse, disponibilité d'indicateurs en temps réel
                  selon sources, adoption par équipe.
                </span>
              </li>
            </ul>
          </div>
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 md:mb-8">Preuves et études de cas</h2>
          <p className="text-base md:text-lg lg:text-xl text-white/80 leading-relaxed mb-8">
            Démarrez avec des démos reproductibles et des exemples anonymisés. Publicons ensuite les cas validés client
            avec tableaux avant/après.
          </p>
          <Link
            href="/etudes-de-cas"
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-10 md:mb-12 text-center">
            FAQ — La Roche-sur-Yon
          </h2>
          <Accordion type="single" collapsible className="space-y-4 md:space-y-5">
            ...
            >
              ...
              <AccordionContent className="text-white/70 text-sm md:text-base leading-relaxed pb-5 md:pb-6">
                Non par défaut. Nous connectons l'existant. Alternative proposée uniquement si ROI évident.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              <AccordionTrigger className="text-base md:text-lg font-semibold hover:no-underline py-5 md:py-6">
                Temps réel ou J+1 sur le reporting ?
              </AccordionTrigger>
              <AccordionContent className="text-white/70 text-sm md:text-base leading-relaxed pb-5 md:pb-6">
            ...
            >
              <AccordionTrigger className="text-base md:text-lg font-semibold hover:no-underline py-5 md:py-6">
                Comment démarrer à La Roche-sur-Yon ?
              </AccordionTrigger>
              <AccordionContent className="text-white/70 text-sm md:text-base leading-relaxed pb-5 md:pb-6">
