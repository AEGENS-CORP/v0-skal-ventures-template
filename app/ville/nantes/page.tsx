  ...
  return (
    <div className="min-h-screen text-white">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              {
                "@type": "Question",
                name: "Le reporting est-il en temps réel à Nantes ?",
                acceptedAnswer: {
                  "@type": "Answer",
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 bg-white/5">
        <div className="max-w-5xl mx-auto">
          <p className="text-base md:text-lg lg:text-xl text-white/80 leading-relaxed">
            Vous cherchez un intégrateur IA à Nantes pour automatiser vos processus, déployer un assistant IA métier et
            livrer un reporting temps réel connecté à vos outils. Intervention prioritaire pour TPE/PME de la métropole
            nantaise avec une approche terrain, sur mesure, orientée croissance/ROI.
          </p>
        </div>
      </section>
          ...
          <div className="space-y-6 md:space-y-8">
            {[
              ...
              },
              {
                ...
                examples: "Exemples: réponse client assistée, tri/solution de tickets, synthèse de contrats.",
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 md:mb-12 text-center">
            Cas d'usage locaux (Nantes Métropole)
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              {
                title: "Industrie / fabrication",
                location: "Carquefou, Saint-Herblain",
                desc: "TRS/OTD, contrôles qualité, alertes de retards et ruptures.",
              },
              {
                title: "Agro / IAA",
                location: "Rezé, Vertou",
                desc: "Traçabilité lots, enregistrements qualité, réassorts dynamiques.",
              },
              {
                title: "Logistique / transport",
                location: "pôle portuaire vers Saint-Nazaire",
                desc: "WMS↔ERP, préparation de tournées, incidents et délais.",
              },
              {
                title: "Services B2B / ESN / cabinets",
                location: "",
                desc: "Assistant documentaire sourcé, saisies et reporting automatisés, SLA support.",
              },
              {
                title: "Retail / e-commerce",
                location: "Atlantis, centre-ville",
                desc: "Cohérence catalogue, commandes→expédition→facture, dashboards ROAS.",
              },
              {
                title: "Comptabilité / juridique",
                location: "",
                desc: "Capture pièces, RAG interne, gabarits de réponses validés.",
              },
            ].map((useCase, i) => (
              <div
                key={i}
          ...
          <p className="text-white/60 text-center mt-10 md:mt-12 italic text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            Tout est étudiable. On part de vos idées et de votre contexte (Nantes, Rezé, Saint-Herblain, Orvault,
            Carquefou, Vertou, Bouguenais, Sainte-Luce).
          </p>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 md:mb-12 text-center">Comment on travaille</h2>
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-10 md:mb-12 text-center">FAQ — Nantes</h2>
          <Accordion type="single" collapsible className="space-y-4 md:space-y-5">
            ...
            >
              ...
              <AccordionContent className="text-white/70 text-sm md:text-base leading-relaxed pb-5 md:pb-6">
                Non par défaut. Nous connectons l'existant. Alternative proposée seulement si ROI évident.
              </AccordionContent>
            </AccordionItem>
