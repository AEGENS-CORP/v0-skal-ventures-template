  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            areaServed: ["Niort", "Deux-Sèvres", "Nouvelle-Aquitaine"],
            sameAs: [],
          }),
        }}
      />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              {
                "@type": "Question",
                name: "Le reporting est-il en temps réel à Niort ?",
                acceptedAnswer: {
                  "@type": "Answer",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accueil", item: "https://aegens.com/" },
              {
                ...
                position: 2,
                name: "Niort",
                item: "https://aegens.com/ville/niort",
              },
            ],
          }),
        }}
      ...
      <section className="py-12 px-4 sm:px-6 bg-white/5 md:py-3.5">
        <div className="max-w-5xl mx-auto">
          <p className="text-base md:text-lg lg:text-xl text-white/80 leading-relaxed">
            Vous cherchez un intégrateur IA à Niort pour automatiser vos flux, déployer un assistant IA métier sur vos
            documents et livrer un reporting temps réel connecté à vos outils. Intervention prioritaire pour TPE/PME
            niortaises avec approche terrain, sur mesure, orientée croissance/ROI.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 md:mb-12 text-center">
            Cas d'usage locaux (Niort, Chauray, Bessines, Aiffres)
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              {
                title: "Assurance / mutuelles",
                desc: "Tri et préparation de dossiers, extraction de clauses, assistant FAQ interne, priorisation des sinistres, tableaux de charge des équipes.",
              },
              {
              ...
              },
              {
                ...
                desc: "Assistant documentaire sourcé, saisies comptables automatisées, SLA support.",
              },
              {
                title: "Retail / e-commerce",
                desc: "Commandes→expédition→facture, cohérence catalogue, dashboards marketing.",
              },
              {
                title: "Logistique",
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-white/5">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-10 md:mb-12 text-center">FAQ — Niort</h2>
