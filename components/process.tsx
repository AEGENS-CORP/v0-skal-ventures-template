    ...
    <section className="py-24 bg-gradient-to-b from-background/50 to-background relative z-10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-sm font-mono text-muted-foreground mb-4 tracking-wider uppercase">Notre méthodologie</h2>
            ...
            >
              ...
              <div className="flex-1 pt-2">
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <span className="text-sm text-muted-foreground font-mono px-3 py-1 rounded-full bg-white/5 border border-white/10">
                    {step.duration}
                  </span>
                </div>
