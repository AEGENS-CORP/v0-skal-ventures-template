    ...
    <section className="py-24 bg-background relative z-10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-sans font-extralight mb-4">Écosystème Partenaires</h2>
        ...
        <div className="text-center">
          <h3 className="text-2xl font-sans font-light mb-8">Nos Clients</h3>
